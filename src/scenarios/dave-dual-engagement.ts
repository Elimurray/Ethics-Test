...
export const daveDualEngagement: Scenario = {
  ...
  facts: [
    { text: 'Dave\u2019s consultancy is ' },
    { text: 'engaged by a property developer to design a new industrial facility', tokenId: 's1' },
    { text: '. At the same time the firm is ' },
    { text: 'contracted by the council for an independent environmental impact assessment', tokenId: 's2' },
    { text: ' of developments in the same area, and Dave is ' },
    { text: 'assigned to both projects', tokenId: 's3' },
    { text: '. It emerges the council\u2019s assessment will ' },
    { text: 'review the environmental impacts of the developer\u2019s own project', tokenId: 's4' },
    { text: ', and Dave ' },
    { text: 'holds confidential information from both clients', tokenId: 's5' },
    { text: '.' },
  ],
  steps: [
